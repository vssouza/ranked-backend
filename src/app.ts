...
import orgContextPlugin from "./plugins/orgContext.js";

import { registerAuthRoutes } from "./routes/auth.js";
import { registerMeRoute } from "./routes/me.js";
import { registerMemberAddressesRoutes } from "./routes/member-addresses.js";
import { registerMeActiveOrganisationRoute } from "./routes/me-active-organisation.js";
...
export async function buildApp() {
  ...
  // 2.5) Load req.org and req.orgRole from X-Org-Id header
  app.register(orgContextPlugin);
  ...
  app.register(async (routes) => {
    ...
    registerMeActiveOrganisationRoute(routes);
